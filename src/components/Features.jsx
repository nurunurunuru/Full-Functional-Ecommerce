    ...
    <section className='max-padd-container py-16'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 bg-white rounded-xl'>
            <div className='p-4 rounded-3xl'>
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime, esse eum unde, possimus iste fuga eligendi sed corporis repudiandae quo accusamus assumenda sequi optio eius hic aspernatur consectetur nostrum quos!</p>
            </div>
            <div className='p-4 rounded-3xl'>
